...
MessageStore.prototype.registerHook = function(){
    ...
    this.addMessage({
        ...
        subject:        "Ka1ttare: Payment Received",
        text:           message,
...
// Don't listen on standard port 110 because it requires root privileges.  Use 1110 instead.
N3.startServer(/* 110, */ 1110, server_name, AuthStore, MessageStore);
